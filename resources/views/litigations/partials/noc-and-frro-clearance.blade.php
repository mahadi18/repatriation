...
<div class="cbrms-tasks" style="height: 3000px">

<header class="panel-heading">
    <h1>NOC</h1>
    <?php if($information['current_task_status']!='Complete') { ?>
        <div class="completer">
            <form class="form-horizontal" action="/cases/{{$litigation->id }}/task/11" method="POST">
    ...
    <?php foreach ($information['forms'] as $form) {
        ...
        <div class="task well form-<?php echo $form->id; ?>">
            ...
            <div class="details">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="completion <?php if($form->status) { echo "done"; }?>">
                            <span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        {!! Form::open(['route' => ['case.form.update',$form->id], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="{{ date('d-m-Y') }}"  class="input-append date dpYears">
                                            <input name="date_of_action" type="text" value="<?php echo $form->date_of_action ? $form->date_of_action : ''; ?>" size="16" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="{{ date('d-m-Y') }}"  class="input-append date dpYears">
                                            <input name="date_of_acknowledgement" type="text" value="<?php echo $form->date_of_acknowledgement?$form->date_of_acknowledgement : ''; ?>" size="16" class="form-control">
                                              <span class="input-group-btn add-on">
                                                <button class="btn btn-success" type="button"><i class="fa fa-calendar-plus-o"></i></button>
                                              </span>
                                        </div>
