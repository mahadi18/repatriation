...
<header class="panel-heading">
    <h1>Repatriation at border</h1>
    <?php if ($information['current_task_status'] != 'Complete') { ?>
        <div class="completer">
            <form class="form-horizontal" action="/cases/{{$litigation->id }}/task/15" method="POST">
...
<?php foreach ($information['forms'] as $form) {
    ...
    <?php
        ...
        <div class="">
        <div class="task well form-<?php echo $form->id; ?>">
        <div class="" role="tab" id="heading<?php echo $form->id; ?>">
            <a class="" role="button" data-toggle="collapse" data-parent="#accordion"
                                                                         href="#collapse<?php echo $form->id; ?>" aria-expanded="false" aria-controls="collapse<?php echo $form->id; ?>">
                <h2><?php if ($form->status) {
                        echo '<i class="fa fa-circle" aria-hidden="true"></i>';
                    } ?>{{$form->title}}</h2></a>
        </div>
