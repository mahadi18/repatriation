...
//                  $task_id = $this::getCurrentTaskId($request); //TODO remove this task_id assignment and replace by $task_id = $request->input('tid');
                   $task_id = $request->input('tid') ? $request->input('tid') : 9; // todo temporary solution to get task id. as previous command is not working.
            ...
            //get the other country except the current loggedin users country
